...
layers configuration. You are free to put any user code."
  ...
  (defun andre/open-externally ()
    (interactive)
    (async-shell-command (format "open %s" (shell-quote-argument buffer-file-name))))
    ...
    (setq org-capture-templates
          '(("t" "Todo (Work)" entry (file+headline andre--work-todo-path "Tasks")
            ...
            ("e" "Emacs" entry (file+headline "~/Dropbox/org/emacs.org" "Emacs tasks")
             "* TODO %?\n%U\n %i")
            ("f" "Flashcard (Work)" entry (file+headline andre--work-todo-path "Flashcards")
             "* TODO %?\n%U\n  %i")))
